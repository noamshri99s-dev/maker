...
const shapes = {
  ...
  chat: (
    <>
      <path d="M5 6.5h14a2.5 2.5 0 0 1 2.5 2.5v7A2.5 2.5 0 0 1 19 18.5h-6L8 21.2v-2.7H5A2.5 2.5 0 0 1 2.5 16V9A2.5 2.5 0 0 1 5 6.5Z" />
    </>
  ),
  mic: (
    <>
  ...
  spark: (
    <>
      <path d="M12 3.5 13.4 9l5.6 1.4L13.4 12 12 17.5 10.6 12 5 10.4 10.6 9 12 3.5Z" />
      <path d="M18.5 15.5 19.2 18l2.3.6-2.3.6-.7 2.5-.7-2.5-2.3-.6 2.3-.6.7-2.5Z" />
    </>
  ),
  clock: (
    <>
  ...
  store: (
    <>
      ...
      <path d="M4 9.5a2.2 2.2 0 0 0 4.3.6 2.2 2.2 0 0 0 4.3 0 2.2 2.2 0 0 0 4.3 0 2.2 2.2 0 0 0 3.1-.6" />
  ...
  sparkle: (
    <>
      ...
      <path d="M18.5 14c.2 1.5.8 2.1 2.3 2.3-1.5.2-2.1.8-2.3 2.3-.2-1.5-.8-2.1-2.3-2.3 1.5-.2 2.1-.8 2.3-2.3Z" />
    </>
  ),
  bag: (
    <>
  ...
  cup: (
    <>
      <path d="M5 8h11v5a5.5 5.5 0 0 1-11 0V8Z" />
